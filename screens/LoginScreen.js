    ...
    if(email&&password){
      try {
        ...
        switch(error.code){
          ...
          alert(`${email} is not recognized, no worries , just register a new account `)
          break;
    ...
    if(email && password){
      try {
        ...
        if(error.code == "auth/invalid-password"){
          alert("The provided value for the password user property is invalid. It must be a string with at least six characters. ")
        }else{
